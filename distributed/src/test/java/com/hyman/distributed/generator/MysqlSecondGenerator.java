...
public class MysqlSecondGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 每张表都有一个创建时间、修改时间。新增时，创建时间和修改时间同时修改，修改时，修改时间更新。
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/test_second?useUnicode=true&useSSL=false&serverTimezone=Asia/Shanghai&autoReconnect=true&characterEncoding=utf8");
